...
function run(){
  ...
  'Philosopher 1 picked up left(0) fork\nPhilosopher 2 picked up left(1) fork.\nPhilosopher 3 picked up left(2) fork.\nPhilosopher 4 picked up left(3) fork.\nPhilosopher 5 picked up left(4) fork.\nPhilosopher 1 picked up right(1) fork.\nPhilosopher 1 is eating.\nPhilosopher 2 picked up right(2) fork.\nPhilosopher 2 is eating.\nPhilosopher 3 picked up right(3) fork.\nPhilosopher 3 is eating.\nPhilosopher 4 picked up right(4) fork.\nPhilosopher 4 is eating.\nPhilosopher 5 picked up right(0) fork.\nPhilosopher 5 is eating.\nPhilosopher 1 is done eating.\nPhilosopher 1 put down left(0) fork.\n'
}